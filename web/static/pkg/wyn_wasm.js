 ...
 * @returns {any}
 */
export function compile_to_shadertoy(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_to_shadertoy(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function compile_with_ir(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_with_ir(ptr0, len0);
    return ret;
}
 ...
 * @returns {string}
 */
export function get_example_program() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_example_program();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {boolean}
 */
export function init_compiler() {
    const ret = wasm.init_compiler();
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wyn_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
